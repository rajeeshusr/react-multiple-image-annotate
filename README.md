...
[![npm version](https://badge.fury.io/js/react-multiple-image-annotate.svg)](https://badge.fury.io/js/react-multiple-annotate)

The best image/video annotation tool ever. [Check out the demo here](https://universaldatatool.github.io/react-multiple-annotate/).
...
`npm install react-multiple-image-annotate`

```javascript
import ReactImageAnnotate from "react-multiple-image-annotate"

const App = () => (
  <ReactMultipleImageAnnotate
...
| `RegionEditLabel`        | `Node`                                           | React Node overriding the form to update the region (see [`RegionLabel`](https://github.com/waoai/react-multiple-annotate/blob/master/src/RegionLabel/index.js))                                                          |               |
...
See more details in the [contributing guidelines](https://github.com/waoai/react-multiple-annotate/wiki/Setup-for-Development).
